...
public class KafkaStreamsBinderHealthIndicator extends AbstractHealthIndicator implements DisposableBean {
	 ...
	 */
	private static ClassLoader classLoader = KafkaStreamsBinderHealthIndicator.class.getClassLoader();
	private static boolean isKafkaStreams25 = true;
	private static Method methodForIsRunning;

	static {
		try {
			Class<?> kafkaStreamsStateClass = classLoader.loadClass("org.apache.kafka.streams.KafkaStreams$State");
